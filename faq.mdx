...
<AccordionItem id="how-to-install" summary="How do I install OpenTofu?">

You can install OpenTofu on Linux, macOS, Windows, and more. See the [installation guide](/docs/intro/install/) for step-by-step instructions for your platform.
